<img src="https://github.com/PumpkinSeed/macdriver2/raw/main/macdriver.gif" alt="MacDriver Logo">

Native Mac APIs for Golang!

[![GoDoc](https://godoc.org/github.com/PumpkinSeed/macdriver2?status.svg)](https://godoc.org/github.com/PumpkinSeed/macdriver2)
<a href="https://github.com/PumpkinSeed/macdriver2/actions?workflow=test"><img alt="Test workflow" src="https://img.shields.io/github/workflow/status/progrium/macdriver/Test?label=test&logo=github&style=flat-square"></a>
[![Go Report Card](https://goreportcard.com/badge/github.com/PumpkinSeed/macdriver2)](https://goreportcard.com/report/github.com/PumpkinSeed/macdriver2)
...
<a href="https://github.com/PumpkinSeed/macdriver2/discussions" title="Project Forum"><img src="https://img.shields.io/badge/community-forum-ff69b4.svg" alt="Project Forum"></a>
...
### Examples
[examples/largetype](https://github.com/PumpkinSeed/macdriver2/blob/main/examples/largetype/main.go#L1) - A Contacts/Quicksilver-style Large Type utility in under 80 lines:
![largetype screenshot](https://pbs.twimg.com/media/EqaoO2MXIAEJNK2?format=jpg&name=large)

[examples/pomodoro](https://github.com/PumpkinSeed/macdriver2/blob/main/examples/pomodoro/main.go#L1) - A menu bar pomodoro timer in under 80 lines:
![pomodoro gif](https://github.com/PumpkinSeed/macdriver2/blob/main/examples/pomodoro/pomodoro.gif?raw=true)


[examples/topframe](https://github.com/PumpkinSeed/macdriver2/blob/main/examples/_topframe/main.go#L1) - An always-on-top webview with transparent background in 120 lines [requires Go 1.16+]: 
